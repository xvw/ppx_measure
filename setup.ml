...
(* OASIS_START *)
(* DO NOT EDIT (digest: dc361b67ca39f7ce3a618aab0b36fc45) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/xvw/ppx_measure";
          synopsis = "Add type safe unit of measure";
          description =
            Some
              [
                 OASISText.Para
                   "A small preprocessor to add type-safe unit of measure"
              ];
          categories = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Ppx_measure"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "ppx_measure";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "ppx_measure.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\019¸à\143Á\024\143á£Z;§Q\128e\006";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
